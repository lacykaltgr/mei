...
from .tools.gabor import create_gabor_loader, create_gabor, default_gabor_ranges, default_gabor_limits
...
class LinearMEI:
    ...
    def __init__(self, operations, shape=(1, 28, 28), bias=0, scale=1, device='cpu'):
        self.bias = bias
        self.scale = scale
        self.device = device
    ...
    def optimal_gabor(self, target_mean=None, target_contrast=None):
        ...
        for op in self.operations:
            ...
            processes.append(MEI_image(image=best_gabor,
                                       bias=self.bias,
                                       scale=self.scale,
                                       device=self.device,
                                       activation=best_activation,
